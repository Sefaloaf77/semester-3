...
$postdetails=$_POST['juduldeskripsi'];
...
$status=1;
$query=mysqli_query($con,"insert into tblberita(JudulBerita,IdKategori,SubCategoryId,DetailBerita,UrlBerita,Is_Active,GambarBerita) values('$posttitle','$catid','$subcatid','$postdetails','$url','$status','$imgnewfile')");
if($query)
{
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="manage-posts.php">Post Berita</a>
                                        </li>
                                        <li>
                                            <a href="add-post.php">Tambah Berita </a>
                                        </li>
                                        <li class="active">
                                            Tambah Berita
                                        </li>
...
<textarea class="summernote" name="deskripsiberita" required></textarea>
</div>
</div>
</div>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Simpan dan Post</button>

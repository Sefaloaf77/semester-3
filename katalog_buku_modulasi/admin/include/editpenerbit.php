    ...
    <div class="card card-info">
      ...
      <div class="col-sm-10">
       <?php if(!empty($_GET['notif'])){?>
          ...
          Maaf Nama Penerbit Wajib Diisi</div>
         <?php }?>
         <?php if($_GET['notif']=="alamatkosong"){?>
          <div class="alert alert-danger" role="alert">
          Maaf Alamat Penerbit Wajib Diisi</div>
         <?php }?>
       <?php }?>
      </div>
      <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-penerbit">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <textarea class="form-control" name="alamat" id="alamat" value="<?php echo $alamat;?>" rows="12"><?php echo $alamat;?></textarea>
            </div>
          </div>
        </div>
        <!-- /.card-body -->

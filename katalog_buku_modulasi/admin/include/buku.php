...
?>
    ...
    <section class="content">
            <div class="card">
                  ...
                  <table class="table table-bordered">
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a href="index.php?include=edit-buku&data=<?php echo $id_buku;?>" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>
              ...
              <!-- /.card-body -->
              <?php 
                $sql_jum = "select `id_buku`, `id_kategori_buku`, `judul`, `id_penerbit`, `tahun_terbit` from `buku`";
                if(!empty($katakunci_buku)){

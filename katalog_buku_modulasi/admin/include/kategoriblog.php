...
if(isset($_POST["katakunci"])){
  $katakunci_kategori_blog = $_POST["katakunci"];
  $_SESSION['katakunci_kategori_blog'] = $katakunci_kategori_blog;
}
if(isset($_SESSION['katakunci_kategori_blog'])){
  $katakunci_kategori_blog = $_SESSION['katakunci_kategori_blog'];
}
?>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="index.php?include=tambah-kategori-blog" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah  Kategori Blog</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <div class="col-sm-12">
                ...
                <table class="table table-bordered">
                  ...
                  if(!isset($_GET['halaman'])){
                      ...
                      `kategori_blog`";
                      if (!empty($katakunci_kategori_blog)){
                        
                         $sql_k .= " where `kategori_blog` LIKE 
                        '%$katakunci_kategori_blog%'";
                        } 
                ...
                <tr>
                  ...
                  <td align="center">
                  <a href="index.php?include=edit-kategori-blog&data=<?php echo $id_kategori_blog;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                  <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>?'))window.location.href ='index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog;?>&notif=hapusberhasil'" 

              ...
              <div class="col-md-12">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $sql_k = "SELECT `id_konten`,`judul`, `tanggal` FROM 
                    `konten`";
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="index.php?include=detail-konten&detail=<?php echo $id_konten;?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>

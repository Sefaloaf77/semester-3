              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td align="center">
                          ...
                          <a href="index.php?include=detail-user&user=<?php echo $id_user;?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
                            <?php echo $nama; ?>?'))window.location.href =  
                             'index.php?include=user&aksi=hapus&data=<?php echo $id_user;?>&notif=hapusberhasil'" 

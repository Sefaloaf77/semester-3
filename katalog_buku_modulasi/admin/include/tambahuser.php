        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?inclue=user">Data User</a></li>
    ...
    <div class="card card-info">
      ...
      <!-- form start -->
          ...
          Masukkan Data yang Ingin Ditambahkan</div>
          <?php }?>
          <?php if($_GET['notif']=="namakosong"){?>
          <div class="alert alert-danger" role="alert">
          Masukkan Data Nama</div>
          <?php }?>
          <?php if($_GET['notif']=="emailkosong"){?>
          <div class="alert alert-danger" role="alert">
          Masukkan Data Email</div>
          <?php }?>
          <?php if($_GET['notif']=="usernamekosong"){?>
          <div class="alert alert-danger" role="alert">
          Masukkan Data Username</div>
          <?php }?>

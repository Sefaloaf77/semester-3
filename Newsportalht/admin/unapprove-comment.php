                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Komentar Menunggu Persetujuan</h4>
...
<strong>Berhasil disetujui!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblkomentar.id,  tblkomentar.nama,tblkomentar.email,tblkomentar.TanggalPosting,tblkomentar.komentar,tblberita.id as postid,tblberita.JudulBerita from  tblkomentar join tblberita on tblberita.id=tblkomentar.postId where tblkomentar.status=0");
$cnt=1;

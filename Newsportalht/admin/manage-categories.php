...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update tblkategori set Is_Active='0' where id='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update tblkategori set Is_Active='1' where id='$id'");
	$msg="Kategori berhasil dipulihkan";
}
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  tblkategori  where id='$id'");
...
<html lang="en">
    <head>
        ...
        <title>iNDOiNFO | Kelola Kategori</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Tambah <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,Kategori,Deskripsi,TanggalPosting,TanggalUpdate from  tblkategori where Is_Active=1");
$cnt=1;
...
<td><?php echo htmlentities($row['TanggalUpdate']);?></td>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Hapus Kategori</h4>
...
<table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,Kategori,Deskripsi,TanggalPosting,TanggalUpdate from  tblkategori where Is_Active=0");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>

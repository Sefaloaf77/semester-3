...
$status=1;
$query=mysqli_query($con,"insert into tblkategori(Kategori,Deskripsi,Is_Active) values('$category','$description','$status')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>iNDOiNFO | Tambah Kategori</title>
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                            <a href="manage-categories">Kategori </a>
                                        </li>
                                        <li class="active">
                                            Tambah Kategori
                                        </li>

      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item">
              <a class="nav-link text-warning" href="index">Home</a>
            </li>
            ...
            <li class="nav-item ps-3">
              ...
              <a class="nav-link ms-3 text-warning" href="category?catid=<?php echo htmlentities($row['id'])?>"><?php echo htmlentities($row['Kategori']);?></a>
            </li><?php } ?>
             <li class="nav-item">
              <a class="nav-link text-warning" href="contact-us">Kontak Kami</a>
            </li> 
          </ul>
          </div>
             <!-- Search Widget -->
